...
if __name__ == "__main__":
    ...
    target = input(electric + "target : " + electric)
    start_port = int(input(electric +"start port : " + electric))
    end_port = int(input(electric + "end port : " + electric))

    start_time = time.time()
    print(f"{yellow}Scanning {target} from port {start_port} to {end_port}...{yellow}")
    scan_ports(target, start_port, end_port)
    print(f"{green}Scan done in {time.time() - start_time:.2f} seconds.{green}")